...
class ImplementoController extends Controller
{
    ...
    public function get_historial_estudiante(){
        ...
        return view('Implemento.historial_estudiante',compact('resultados','mostrarResultados','botonApretado'));
    }
    ...
    public function get_historial_moderador(){
        ...
        return view('Implemento.historial_moderador',compact('resultados','mostrarResultados','botonApretado', 'ubicacionesImplementos', 'estadosImplementos'));
    }
