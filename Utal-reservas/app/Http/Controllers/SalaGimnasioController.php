...
class SalaGimnasioController extends Controller
{
    ...
    if($resultadosSeleccionados!=null){
        ...
        if($fecha_actual == $fecha_reserva){
            ...
            if($hora_actual>$hora_actual_modificada){
                return redirect()->route('salagimnasio_cancelar')->with('error', '¡Solo puedes cancelar con 2 horas de anticipación!');
            }
    ...
    public function get_historial_estudiante(){
        ...
        return view('SalaGimnasio.historial_estudiante',compact('resultados','mostrarResultados','botonApretado'));
    }
