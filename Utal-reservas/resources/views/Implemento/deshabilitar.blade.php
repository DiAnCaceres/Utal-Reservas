...
@section('content')
    ...
    <div class="botonera">
        ...
        <button type="button" class="btn btn-default col-xs-4 boton_servicios" onclick="window.location='{{ route('cancha_deshabilitar') }}'">Canchas</button>
        <button type="button" class="btn btn-default col-xs-4 boton_activo">Implementos</button>
    </div>

    <br>
    <h1 style="text-align:center; font-weight:bold;">Deshabilitar Implemento</h1>
    <br>
    ...
    <div class="box_recepcionar_ligteblue1">
        <div id="div_resultados">
            ...
            <form action="{{route('post_implemento_deshabilitar')}}" method="POST">
                @csrf
