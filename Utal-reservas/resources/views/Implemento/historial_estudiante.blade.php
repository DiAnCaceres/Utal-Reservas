...
@section('content')
    ...
    <h1>Mi Historial de Reservas: Implementos</h1>
    ...
    <div class="box_recepcionar_ligteblue">
        <div id="div_resultados">
            ...
            <form action="{{route('post_implemento_historial_estudiante')}}" method="POST">
                @csrf
                ...
                @elseif($mostrarResultados==true and $botonApretado==true)
                    <button type="button"  onclick="window.location='{{ route('implemento_historial_estudiante') }}'">Volver al historial sin filtro</button>
                @endif
