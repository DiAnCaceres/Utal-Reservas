...
@section('content')
    ...
    <h1> Historial Salas Gimnasio</h1>
    ...
    <div class="box_recepcionar_ligteblue">
        <div id="div_resultados">
            ...
            <form action="{{route('post_salagimnasio_historial_moderador')}}" method="POST">
                @csrf
                ...
                @elseif($mostrarResultados==true and $botonApretado==true)
                    <button type="button"  onclick="window.location='{{ route('salagimnasio_historial_moderador') }}'">Volver al historial sin filtro</button>
                @endif
