...
@section('content')
    ...
    <h1>Mi Historial de Reservas: Canchas</h1>
    ...
    <div class="box_recepcionar_ligteblue">
        <div id="div_resultados">
            ...
            <form action="{{route('post_cancha_historial_estudiante')}}" method="POST">
                @csrf
                ...
                @elseif($mostrarResultados==true and $botonApretado==true)
                    <button type="button"  onclick="window.location='{{ route('cancha_historial_estudiante') }}'">Volver al historial sin filtro</button>
                @endif
