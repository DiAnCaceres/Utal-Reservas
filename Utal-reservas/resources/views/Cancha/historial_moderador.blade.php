...
@section('content')
    ...
    <div class="filtros">
        <form method="POST" action="post_cancha_historial_moderador">
            @csrf
            <h1>Filtrar por:</h1>
            <div class="labels">
            ...
            @elseif($mostrarResultados==true and $botonApretado==true)
                <button class="button" type="button"  onclick="window.location='{{ route('cancha_historial_moderador') }}'">Volver al historial sin filtro</button>
            @endif
        </form>
