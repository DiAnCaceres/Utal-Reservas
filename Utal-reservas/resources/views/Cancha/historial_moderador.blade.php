...
@section('content')
    ...
    <div class="box_recepcionar_ligteblue">
        <div id="div_resultados">
            ...
            <form action="{{route('post_cancha_historial_moderador')}}" method="POST">
                @csrf
                ...
                @elseif($mostrarResultados==true and $botonApretado==true)
                    <button type="button"  onclick="window.location='{{ route('cancha_historial_moderador') }}'">Volver al historial sin filtro</button>
                @endif
